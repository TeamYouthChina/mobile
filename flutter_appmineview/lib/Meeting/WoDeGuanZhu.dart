        ...
        Container(
          ...
          child: Row(
            children: <Widget>[
              Text(
                '正在进行',
                style: TextStyle(color: Color(0xFF454F69), fontSize: 14),
              ),
            ],
          ),
        ),
...
class _MeetingCardState extends State<MeetingCard> {
  ...
  Widget build(BuildContext context) {
    ...
    text = text ??
        "参与者：郭老师，顾老师，美老师，美老师";
    titlestyle = titlestyle ?? TextStyle(color: Color(0xFF454F69), fontSize: 16);
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Text(
                          foot2,
                          style:
                              TextStyle(color: Theme.of(context).accentColor, fontSize: footsize),
                        ),
                      ),
                    ],
                  ),
