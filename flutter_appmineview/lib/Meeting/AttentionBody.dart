      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            child: Column(
              children: <Widget>[
                new CheckingButtonBar(state:"   正在进行"),  //Container
          ...
          Container(height: 2.0, margin: EdgeInsets.only(top: 10.0),decoration: BoxDecoration(color: Colors.grey)),
          Container(height: 2.0, child: Text('')),
          Container(
            child: Column(
              children: <Widget>[
                new CheckingButtonBar(state:"   即将开始"),
